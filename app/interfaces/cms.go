...
type CmsRepository interface {
	...
	GetRelatedTableData(tableName string, relatedTable string) (res []map[string]interface{}, err error)
...
type CmsService interface {
	...
	GetTableData(tableName string, relatedTables []string, opts *pagination.Options) (res map[string]interface{}, metadata pagination.Metadata, status int, err error)
